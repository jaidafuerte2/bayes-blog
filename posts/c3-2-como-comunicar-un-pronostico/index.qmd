---
title: "¿Cómo comunicar un pronóstico sin crear una falsa sensación de certeza?"

description: "Aprende a comunicar un pronóstico bayesiano de ventas mostrando escenarios plausibles e incertidumbre para tomar decisiones de negocio más informadas."
...
Después de agrupar las transacciones por mes obtenemos **48 observaciones mensuales**.
...
Cada observación representa las ventas totales de un mes.
...
* enero de 2014 → `Tiempo = 1`
* febrero de 2014 → `Tiempo = 2`
* ...
* diciembre de 2017 → `Tiempo = 48`
...
Esto es importante porque antes de modelar una serie temporal necesitamos comprobar que la variable que representa el tiempo realmente quedó disponible y correctamente transformada.
...
Cada valor representa un posible resultado compatible con el modelo.
...
Esto significa que el modelo representa la evolución de las ventas fundamentalmente mediante una tendencia temporal.
